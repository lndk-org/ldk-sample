...
use crate::{
	...
	OutboundPaymentInfoStorage, PaymentInfo, PeerManagerType,
};
...
pub(crate) fn poll_for_user_input(
	peer_manager: Arc<PeerManagerType>, channel_manager: Arc<ChannelManager>,
...
fn node_info(channel_manager: &Arc<ChannelManager>, peer_manager: &Arc<PeerManagerType>) {
	println!("\t{{");
...
fn do_disconnect_peer(
	pubkey: bitcoin::secp256k1::PublicKey, peer_manager: Arc<PeerManagerType>,
